...
variable "tf_state_bucket" {
  ...
  type        = string
  default     = "refunds-service-tfstate-staging"
}

variable "tf_state_key" {
  description = "S3 key for the Terraform state file"
  type        = string
  default     = "environments/staging/terraform.tfstate"
}

variable "tf_state_dynamodb_table" {
  description = "DynamoDB table for Terraform state locking"
  type        = string
  default     = "refunds-service-tflock-staging"
}
...
variable "single_nat_gateway" {
  description = "Whether to use a single NAT Gateway (false for high availability in staging)"
  type        = bool
  default     = false
}
...
variable "mongodb_project_name" {
  ...
  type        = string
  default     = "refunds-service-staging"
}

variable "mongodb_cluster_name" {
  description = "MongoDB Atlas cluster name"
  type        = string
  default     = "refunds-staging"
}

variable "mongodb_instance_size" {
  description = "MongoDB Atlas instance size (moderately sized for staging)"
  type        = string
  default     = "M30"
}
...
# Service configuration - Refund API Service
...
# Service configuration - Refund Request Manager
...
# Service configuration - Gateway Integration Service
...
# Service configuration - Parameter Resolution Service
...
# Service configuration - Reporting & Analytics Engine
...
variable "cloudwatch_log_group_name" {
  ...
  type        = string
  default     = "/ecs/refunds-service-staging"
}
...
variable "document_bucket_name" {
  ...
  type        = string
  default     = "refunds-service-documents-staging"
}

variable "log_bucket_name" {
  description = "S3 bucket name for storing application logs"
  type        = string
  default     = "refunds-service-logs-staging"
}
